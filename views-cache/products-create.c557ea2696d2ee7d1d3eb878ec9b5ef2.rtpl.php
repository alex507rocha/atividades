...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="/admin/products">Atividades</a></li>
  	...
  	<div class="col-md-12">
        ...
        <form role="form" action="/admin/products/create" method="post">
          <div class="box-body">
            ...
            <div class="form-group">
              <label for="desproduct">Descrição da atividade</label>
            ...
            <div class="form-group">
              ...
              <div class="input-group date">
                ...
                <input type="date" class="form-control pull-right" id="dtinicioatividade">
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="input-group date">
                ...
                <input type="date" class="form-control pull-right" id="dtfimatividades">
              </div>
            </div>

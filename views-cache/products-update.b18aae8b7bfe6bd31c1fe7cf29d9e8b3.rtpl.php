          ...
          <form role="form" action="/admin/products/<?php echo htmlspecialchars( $product["idproduct"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" method="post" enctype="multipart/form-data">
            <div class="box-body">
              <div class="form-group">
                ...
                <textarea rows="5" cols="100" class="form-control" id="desproduct" name="desproduct" placeholder="Digite o nome do produto" name='textdesc'><?php echo htmlspecialchars( $product["desproduct"], ENT_COMPAT, 'UTF-8', FALSE ); ?></textarea>
              </div>
              <div class="form-group">
